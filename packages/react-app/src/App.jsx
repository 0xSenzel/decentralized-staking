...
function App(props) {
  ...
  // Set Staked Ether Amount
  const [ethAmount, setEthAmount] = useState("");
  // Track amount of ETH key in by user to stake
  const onEthStakedChange = event => {
  ...
  const rewardRatePerYear = useContractReader(readContracts, "Staker", "rewardRatePerYear");
  console.log("💵 Reward Rate:", rewardRatePerYear);

  // ** keep track of a variable from the contract in the local React state:
  const balanceStaked = useContractReader(readContracts, "Staker", "balances", [address]);
  console.log("💸 balanceStaked:", balanceStaked);

  // ** Show Amount of ETH eligible to withdraw by the end of staking
  const totalWithdraw = useContractReader(readContracts, "Staker", "totalWithdraw", [address]);
  ...
  const completed = useContractReader(readContracts, "ExampleExternalContract", "completed");
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8, marginTop: 16 }}>
              <div>APY:</div>
              <Balance balance={rewardRatePerYear} fontSize={64} /> %
            </div>
            ...
            <div style={{ padding: 8, fontWeight: "bold" }}>
              ...
              <div>Total Eligible ETH 🤑:</div>
              <Balance balance={totalWithdraw} fontSize={64} />
            </div>
            ...
            <div style={{ padding: 8 }}>
              ...
              <Button
                ...
                type={"default"}
                onClick={() => {
                  tx(writeContracts.ExampleExternalContract.deexecute(readContracts.Staker.address));
                }}
              >
                🪂 De-Execute!
              </Button>
            ...
            <div style={{ padding: 8 }}>
              ...
              <Button
                ...
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.withdrawExpiredFund());
                }}
              >
                🧓 Withdraw Expired Fund
              </Button>
            </div>

            <div style={{ padding: 8, color: "black" }}>
              <input type="text" placeholder="Enter ETH Amount to Stake..." onChange={onEthStakedChange} />
            </div>
            ...
            <div style={{ padding: 8 }}>
              <Button
                ...
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(ethAmount) }));
                }}
              >
                🥩 Stake your ether!
              </Button>
      ...
      <div style={{ marginTop: 32, opacity: 0.5 }}>
        ...
        Created by{" "}
        <Address value={"0x37f2BD3F66D680acE396f9EAB894be824E7d9B2F"} ensProvider={mainnetProvider} fontSize={16} />
      </div>
